<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateBook.aspx.cs" Inherits="WebApplicationForm_Library.UpdateBook" %>
...
<body>
    ...
    <div class="container">
            ...
            <table class="table table-bordered" >
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="ButtonUpdate" CssClass="btn btn-success btn-block" runat="server" Text="UPDATE" OnClick="ButtonUpdate_Click"  />
                    </td>
                </tr>
